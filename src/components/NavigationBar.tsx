...
const tabs = [
  ...
  { id: 'plots', labels: { en: 'Data Control', pl: 'Kontrola Danych' } },
  { id: 'interactive', labels: { en: 'Blank', pl: 'Blank' } },
  { id: 'compiler', labels: { en: 'Curves Smoothing', pl: 'Wygładzanie Krzywych' } },
