...
export default function PlotsViewer(){
  ...
  // Opacity of the legend box when placed inside the chart
  const [insideLegendOpacity, setInsideLegendOpacity] = useState<number>(0.9);
  ...
  const renderLegend = useCallback(
    (placement: LegendPlacement) => {
      ...
      function LegendContent() {
        ...
        const containerStyle: CSSProperties = {
          resize: 'none',
          overflow: 'auto',
          background: `rgba(255,255,255,${placement === 'inside' ? insideLegendOpacity : 0.8})`,
        ...
        // Drag handlers (active only when placement === 'inside')
        ...
        return (
          <div ref={ref} style={containerStyle}>
            <div onMouseDown={onMouseDownDrag}
             style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', cursor: placement === 'inside' ? 'grab' : 'default', userSelect: 'none',}}>
    ...
    [legendSections, legendChipMetrics, legendVisible, legendTitle, legendContentScale, insideLegendOpacity],
  );
        ...
        <>
          ...
          <div className="panel" style={{ marginTop: 12 }}>
            ...
            <div className="row" style={{ justifyContent: 'space-between', gap: 8, marginTop: 8, flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              {legendVisible && legendPlacement === 'inside' && (
              <div className="row" style={{ gap: 6, alignItems: 'center' }}>
                ...
                <input
                  ...
                  max={1}
                  step={0.05}
                  value={insideLegendOpacity}
                  onChange={(e) => setInsideLegendOpacity(+e.target.value)}
                  style={{ width: 120 }}
                />
                <span className="small">{Math.round(insideLegendOpacity * 100)}%</span>
              </div>
            )}
