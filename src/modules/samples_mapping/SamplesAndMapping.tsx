        ...
        <div className="panel panel-landing full-span">
          <div className="panel-heading with-help">
            <div>
              ...
              <p className="small">
                {isPl
                  ? 'Wczytaj zapisane mapowania lub pliki assignment z wcześniejszych sesji.'
                  : 'Load saved mappings or assignment files from previous sessions.'}
              </p>
            </div>
            <button
              ref={importAssignRef}
          ...
          <HelpTooltip anchorRef={importAssignRef} open={!!help.import}>
            {isPl
              ? 'Załaduj pliki assignment lub surowe dane pomiarowe, aby kontynuować pracę z poprzedniej sesji.'
              : 'Load assignment files or raw measurements to continue from a previous session.'}
          </HelpTooltip>
          <div className="row" style={{ gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
            <label className="btn" style={{ cursor: 'pointer' }}>
              {isPl ? 'Importuj plik (dowolny)' : 'Import data (any file)'}
              <input
                type="file"
        ...
        <div className="panel panel-soft full-span">
          <div className="panel-heading with-help">
            <div>
              ...
              <p className="small">
                {isPl ? 'Dodaj surowe pliki pomiarowe do konwersji.' : 'Add raw measurement files for conversion.'}
              </p>
            </div>
            <button
              ref={importDataRef}
          ...
          <HelpTooltip anchorRef={importDataRef} open={!!help.importData}>
            {isPl
              ? 'Wczytaj surowe pliki pomiarowe (CSV/JSON/XLSX), aby konwertować je w panelu poniżej.'
              : 'Load raw measurement files (CSV/JSON/XLSX) to convert them in the panel below.'}
          </HelpTooltip>
          <div className="row" style={{ gap: 8, flexWrap: 'wrap', alignItems: 'center' }}>
            <label className="btn" style={{ cursor: 'pointer' }}>
              {importLabel}
